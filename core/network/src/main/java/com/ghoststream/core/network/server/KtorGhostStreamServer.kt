                ...
                call.respond(
                    BrowserBootstrap(
                        ...
                        strings = mapOf(
                            ...
                            "web_status_selected" to localizedContext.getString(R.string.web_status_selected),
                            "web_action_select" to localizedContext.getString(R.string.web_action_select),
                            "web_btn_retry" to localizedContext.getString(R.string.web_btn_retry),
                            "web_status_preparing" to localizedContext.getString(R.string.web_status_preparing),
                            "web_btn_prepare_for_browser" to localizedContext.getString(R.string.web_btn_prepare_for_browser),
                            "web_error_video_opening" to localizedContext.getString(R.string.web_error_video_opening),
                            "web_action_previous" to localizedContext.getString(R.string.web_action_previous),
                            "web_action_next" to localizedContext.getString(R.string.web_action_next),
                            "web_btn_back_to_photos" to localizedContext.getString(R.string.web_btn_back_to_photos),
                            "web_error_no_preview" to localizedContext.getString(R.string.web_error_no_preview),
                            "web_error_pin_mismatch" to localizedContext.getString(R.string.browser_pin_mismatch),
                            ...
                            "web_player_status_stopped" to localizedContext.getString(R.string.web_player_status_stopped),
                            ...
                            "web_player_stalled" to localizedContext.getString(R.string.web_player_stalled),
                            "web_player_stalled_desc" to localizedContext.getString(R.string.web_player_stalled_desc),
                            "web_player_analyzing" to localizedContext.getString(R.string.web_player_analyzing),
                            "web_player_analyzing_desc" to localizedContext.getString(R.string.web_player_analyzing_desc),
                            "web_player_finalizing" to localizedContext.getString(R.string.web_player_finalizing),
                            "web_player_finalizing_desc" to localizedContext.getString(R.string.web_player_finalizing_desc),
                            "web_player_needs_prepare" to localizedContext.getString(R.string.web_player_needs_prepare),
                            "web_player_needs_prepare_desc" to localizedContext.getString(R.string.web_player_needs_prepare_desc),
                            "web_player_status_stalled" to localizedContext.getString(R.string.web_player_status_stalled),
                            "web_player_status_analyzing" to localizedContext.getString(R.string.web_player_status_analyzing),
                            "web_player_status_finalizing" to localizedContext.getString(R.string.web_player_status_finalizing),
                            "web_status_init_progress" to localizedContext.getString(R.string.web_status_init_progress),
                            "web_btn_load_more" to localizedContext.getString(R.string.web_btn_load_more),
                            "common_separator_pipe" to localizedContext.getString(R.string.common_separator_pipe),
                            "common_separator_dot" to localizedContext.getString(R.string.common_separator_dot),
                            "web_btn_show_all" to localizedContext.getString(R.string.web_btn_show_all),
                            "web_btn_showing_all" to localizedContext.getString(R.string.web_btn_showing_all),
                            "web_show_all_confirm" to localizedContext.getString(R.string.web_show_all_confirm),
                            "web_library_showing_count" to localizedContext.getString(R.string.web_library_showing_count),
                            "web_upload_denied" to localizedContext.getString(R.string.web_upload_denied),
                            "web_upload_failed_status" to localizedContext.getString(R.string.web_upload_failed_status),
                            "web_upload_network_error" to localizedContext.getString(R.string.web_upload_network_error),
                            "web_upload_cancelled" to localizedContext.getString(R.string.web_upload_cancelled),
                            "web_error_internal_server_error" to localizedContext.getString(R.string.web_error_internal_server_error),
                            "web_error_preview_unavailable" to localizedContext.getString(R.string.web_error_preview_unavailable),
                            "web_error_direct_stream_disabled" to localizedContext.getString(R.string.web_error_direct_stream_disabled),
                            "web_error_subtitle_unavailable" to localizedContext.getString(R.string.web_error_subtitle_unavailable),
                            "web_error_invalid_upload_request" to localizedContext.getString(R.string.web_error_invalid_upload_request),
                            "web_error_upload_declined" to localizedContext.getString(R.string.web_error_upload_declined),
                            "web_error_upload_save_failed" to localizedContext.getString(R.string.web_error_upload_save_failed),
                            "web_btn_fullscreen" to localizedContext.getString(R.string.web_btn_fullscreen),
                            "web_action_download_zip" to localizedContext.getString(R.string.web_action_download_zip),
                            "web_btn_download_all_zip" to localizedContext.getString(R.string.web_btn_download_all_zip),
                            "web_btn_download_selected_zip" to localizedContext.getString(R.string.web_btn_download_selected_zip),
                            "web_error_no_items_selected" to localizedContext.getString(R.string.web_error_no_items_selected),
                            "web_download_started_hint" to localizedContext.getString(R.string.web_download_started_hint),
                            "web_error_load_failed" to localizedContext.getString(R.string.web_error_load_failed),
                            "web_upload_selection_empty" to localizedContext.getString(R.string.web_upload_selection_empty),
                            "web_upload_selection_single" to localizedContext.getString(R.string.web_upload_selection_single),
                            "web_upload_selection_multiple" to localizedContext.getString(R.string.web_upload_selection_multiple),
                            "web_upload_button_send" to localizedContext.getString(R.string.web_upload_button_send),
                            "common_unit_b" to localizedContext.getString(R.string.common_unit_b),
                            "common_unit_kb" to localizedContext.getString(R.string.common_unit_kb),
                            "common_unit_mb" to localizedContext.getString(R.string.common_unit_mb),
                            "common_unit_gb" to localizedContext.getString(R.string.common_unit_gb),
                            "common_unit_tb" to localizedContext.getString(R.string.common_unit_tb),
                        ),
                    ),
                )
            }
