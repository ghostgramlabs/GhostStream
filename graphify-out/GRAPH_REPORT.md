...
## Corpus Check
- 177 files · ~414,720 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2583 nodes · 4936 edges · 142 communities detected
...
Cohesion: 0.02
Nodes (108): Aa(), Ad(), addMetadata(), am(), assignObjectToOutput(), assignToOutput(), authQuery(), authUrl() (+100 more)
...
Cohesion: 0.04
Nodes (114): l(), O(), $0(), a2(), Af(), ah(), al(), as() (+106 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (87): getUploadDisplayFiles(), vi(), #_(), ab(), addFile(), addFiles(), addResultData(), addResultToForm() (+79 more)
...
Cohesion: 0.06
Nodes (45): add(), addPostProcessor(), addPreProcessor(), addTarget(), addUploader(), applyInheritables(), batchEnableWithBool(), batchEnableWithUserValue() (+37 more)
...
Cohesion: 0.07
Nodes (43): ho(), abort(), cancelSelection(), captureScreenshot(), changeVideoSource(), clearSearchState(), discardRecordedMedia(), donePicking() (+35 more)
...
Cohesion: 0.09
Nodes (32): create(), j(), _1(), a(), a1(), F(), getAssemblyStatus(), gl() (+24 more)
...
Cohesion: 0.09
Nodes (29): bm(), bw(), Dm(), eo(), Ew(), fm(), Fr(), Fw() (+21 more)

### Community 23 - "Community 23"
Cohesion: 0.1
Nodes (28): ac(), bo(), componentDidUpdate(), componentWillMount(), componentWillUnmount(), cy(), Dy(), ei() (+20 more)
...
Cohesion: 0.08
Nodes (23): waitForLiveIceGathering(), Jr(), ResolvedSessionEndpoint, SessionEndpointResolver, Ar(), fo(), getImage(), getVideo() (+15 more)
...
Cohesion: 0.11
Nodes (24): Ae(), an(), Ch(), d(), dt(), Fe(), Fg(), getID() (+16 more)

### Community 30 - "Community 30"
Cohesion: 0.13
Nodes (24): bc(), Ci(), fb(), Ft(), fy(), Iv(), jv(), Ki() (+16 more)
...
Cohesion: 0.11
Nodes (19): addSource(), assembly(), #b(), componentDidMount(), connect(), #o(), off(), on() (+11 more)
...
- **Thin community `Community 101`** (2 nodes): `LanguageSelectionScreen.kt`, `LanguageSelectionScreen()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 102`** (2 nodes): `AppContainer`, `AppContainer.kt`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 103`** (2 nodes): `Theme.kt`, `GhostStreamTheme()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 104`** (2 nodes): `ClientCapabilities.kt`, `ClientCapabilities`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 105`** (2 nodes): `GhostSpacing.kt`, `GhostSpacing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 106`** (2 nodes): `NetworkSetupScreen.kt`, `NetworkSetupScreen()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 107`** (2 nodes): `loc_fixer_injector.py`, `inject()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 108`** (1 nodes): `build.gradle.kts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 109`** (1 nodes): `settings.gradle.kts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 110`** (1 nodes): `build.gradle.kts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 111`** (1 nodes): `Color.kt`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 125`** (1 nodes): `build.gradle.kts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 126`** (1 nodes): `build.gradle.kts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 127`** (1 nodes): `export_english.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 128`** (1 nodes): `find_dupes.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 129`** (1 nodes): `flatten_history_quicktext.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 130`** (1 nodes): `flatten_library.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 131`** (1 nodes): `flatten_onboarding.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 132`** (1 nodes): `flatten_session.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 133`** (1 nodes): `flatten_settings.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 134`** (1 nodes): `rewrite_home_screen.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 135`** (1 nodes): `clean_quotes.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 136`** (1 nodes): `escape_quotes.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 137`** (1 nodes): `translate_chunk1.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 138`** (1 nodes): `translate_chunk2.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 139`** (1 nodes): `translate_chunk3.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 140`** (1 nodes): `translate_chunk4.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `get()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 10`, `Community 12`, `Community 17`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `ht` connect `Community 4` to `Community 0`?**
