# Graph Report - C:\Users\sudhi\.gemini\antigravity\scratch\GhostStream  (2026-04-22)

## Corpus Check
- 135 files · ~300,420 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2220 nodes · 4374 edges · 115 communities detected
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 389 edges (avg confidence: 0.8)
...
3. `e()` - 69 edges
4. `filter()` - 50 edges
5. `MainViewModel` - 49 edges
6. `log()` - 47 edges
7. `constructor()` - 46 edges
8. `render()` - 43 edges
9. `get()` - 43 edges
10. `KtorGhostStreamServer` - 42 edges

## Surprising Connections (you probably didn't know these)
- `getUploadDisplayFiles()` --calls--> `getFiles()`  [INFERRED]
...
Cohesion: 0.01
Nodes (396): Ir(), l(), O(), ResolvedSessionEndpoint, SessionEndpointResolver, translate_html_safe(), $0(), _1() (+388 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (169): formatTime(), a(), Ae(), ai(), ar(), assetPlayers(), be(), bi() (+161 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (143): create(), ho(), Jr(), vi(), j(), #_(), a(), ab() (+135 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (119): addFilesToUppy(), api(), applyAspectRatioLayout(), applyBootstrapUi(), attachMusicPlayers(), bindLibraryControls(), bindSelectableCards(), boot() (+111 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (44): _(), A(), ae(), at, B(), C(), ce(), ct (+36 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (100): br(), gr(), Gs(), za(), zs(), AdvertisedServiceRegistration, AdvertisedSessionInfo, DiscoveryMetadata (+92 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (17): AuthResult, BrowserBootstrap, BrowserCategories, BrowserDebugPayload, BrowserItemCard, BrowserItemDetails, BrowserItemsPage, CompatibilityStatusPayload (+9 more)
...
Cohesion: 0.05
Nodes (51): lt(), add(), addPostProcessor(), addPreProcessor(), addUploader(), Ae(), applyInheritables(), batchEnableWithBool() (+43 more)
...
Cohesion: 0.11
Nodes (5): DebugLogRepository, batch_translate(), Batch-fill missing translations. Groups strings into chunks and translates them, Translate a list of texts in batches using a separator., createAssembly()

### Community 25 - "Community 25"
Cohesion: 0.13
Nodes (14): AppEvent, MainUiState, NavigateHistory, NavigateHome, NavigateLibrary, NavigateNetworkSetup, NavigateSession, OpenExternalUrl (+6 more)
...
Cohesion: 0.33
Nodes (7): X(), focus(), gh(), kb(), Ms(), wl(), yh()
...
Cohesion: 0.53
Nodes (4): DeviceIdentity, formatGeneratedNameWithIp(), formatHistoryPeer(), looksLikeIpAddress()
...
## Knowledge Gaps
- **99 isolated node(s):** `Routes`, `AppLanguage`, `AppContainer`, `MainUiState`, `AppEvent` (+94 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 83`** (2 nodes): `LanguageSelectionScreen.kt`, `LanguageSelectionScreen()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 84`** (2 nodes): `AppContainer`, `AppContainer.kt`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 85`** (2 nodes): `Theme.kt`, `GhostStreamTheme()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 86`** (2 nodes): `ClientCapabilities.kt`, `ClientCapabilities`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 87`** (2 nodes): `GhostSpacing.kt`, `GhostSpacing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 88`** (2 nodes): `NetworkSetupScreen.kt`, `NetworkSetupScreen()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 89`** (1 nodes): `build.gradle.kts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 90`** (1 nodes): `settings.gradle.kts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 91`** (1 nodes): `build.gradle.kts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 92`** (1 nodes): `Color.kt`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 93`** (1 nodes): `build.gradle.kts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 101`** (1 nodes): `build.gradle.kts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 102`** (1 nodes): `build.gradle.kts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 107`** (1 nodes): `build.gradle.kts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 108`** (1 nodes): `clean_quotes.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 109`** (1 nodes): `escape_quotes.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 110`** (1 nodes): `translate_chunk1.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 111`** (1 nodes): `translate_chunk2.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 112`** (1 nodes): `translate_chunk3.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 113`** (1 nodes): `translate_chunk4.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `filter()` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 8`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `get()` connect `Community 5` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 8`?**
...
- **Are the 19 inferred relationships involving `filter()` (e.g. with `renderHome()` and `downloadItems()`) actually correct?**
