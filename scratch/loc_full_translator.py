...
def translate_in_batches(translator, items_to_trans, batch_size=50):
    # items_to_trans is list of tuples: (key, original_text, type, qty)
    results = {}
...
def main():
    ...
    print(f"Starting parallel full translation for {len(folders_to_process)} locales...")
